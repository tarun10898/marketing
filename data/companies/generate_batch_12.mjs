...
const companies = [
  {
    ...
    category: 'product',
    multiplier: 1.16,
    preferred_skills: ['DSA', 'System Design', 'Security Engineering', 'Cloud', 'Networking', 'Python'],
    eligibility: 'Strong coding and security-platform fundamentals for large-scale cloud security products.',
    student_perception: 'Top security product company with strong engineering depth and impact.',
  },
  {
    company_name: 'CrowdStrike India',
    ...
    category: 'product',
    multiplier: 1.15,
    preferred_skills: ['DSA', 'System Design', 'Security Engineering', 'Cloud', 'Go', 'Linux'],
    eligibility: 'Strong coding and systems-security fundamentals for cloud-native security platforms.',
    student_perception: 'High-growth security product environment with strong technical ownership.',
  },
  {
    company_name: 'SentinelOne India',
    ...
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'Security Engineering', 'Cloud', 'Distributed Systems', 'Go'],
    eligibility: 'Strong coding and backend-security fundamentals for autonomous endpoint protection systems.',
    student_perception: 'Modern cybersecurity product company with strong engineering ownership.',
  },
  {
    company_name: 'Docker India',
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'DevOps', 'Containers', 'Cloud', 'Go'],
    eligibility: 'Strong coding and platform engineering fundamentals for container ecosystems.',
    student_perception: 'Core developer tooling company with strong platform ownership opportunities.',
  },
  {
    company_name: 'HashiCorp India',
    ...
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'Cloud', 'IaC', 'Security', 'Go'],
    eligibility: 'Strong coding and cloud platform fundamentals with infrastructure automation depth.',
    student_perception: 'Strong cloud infra tooling company with high practical relevance.',
  },
  {
    company_name: 'New Relic India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.06,
    preferred_skills: ['DSA', 'System Design', 'Observability', 'Cloud', 'Distributed Systems', 'Java'],
    eligibility: 'Strong coding and reliability engineering fundamentals for observability products.',
    student_perception: 'Good platform engineering environment focused on production reliability tooling.',
  },
  {
    company_name: 'Snyk India',
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Security', 'Developer Tools', 'Cloud', 'JavaScript'],
    eligibility: 'Strong coding and AppSec/product engineering fundamentals.',
    student_perception: 'Modern security tooling company with strong developer-centric engineering scope.',
  },
  {
    company_name: 'F5 India',
    ...
    category: 'product',
    multiplier: 1.04,
    preferred_skills: ['DSA', 'System Design', 'Networking', 'Security', 'Linux', 'Cloud'],
    eligibility: 'Strong systems and network engineering fundamentals for edge and security platforms.',
    student_perception: 'Reliable networking/security engineering path with solid systems exposure.',
  },
  {
    company_name: 'Zscaler India',
    ...
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'Security', 'Cloud', 'Networking', 'Go'],
    eligibility: 'Strong coding and cloud security fundamentals for large-scale edge security systems.',
    student_perception: 'Strong security product company with high-impact platform engineering roles.',
  },
  {
    ...
    category: 'product',
    multiplier: 1.15,
    preferred_skills: ['DSA', 'System Design', 'Distributed Systems', 'Networking', 'Security', 'Go'],
    eligibility: 'Strong systems coding and edge platform engineering fundamentals.',
    student_perception: 'Top edge infrastructure and security platform with strong technical growth potential.',
  },
];
...
writeFileSync('data/companies/companies_batch_12.json', `${JSON.stringify(batch, null, 2)}\n`, 'utf8');
console.log('Created data/companies/companies_batch_12.json with', batch.length, 'companies');
