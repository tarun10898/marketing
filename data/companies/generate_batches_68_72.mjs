...
const batches = {
  68: {
    name: "Sugar, Distillery, and Ethanol",
    companies: [
  ...
  69: {
    name: "Mining, Minerals, and Metal Extraction",
    companies: [
  ...
  70: {
    name: "Printing, Publication, and News Media",
    companies: [
      "DB Corp India",
      "Mathrubhumi India",
      "Eenadu India",
  ...
  71: {
    name: "Plastic, Polymer, and Petrochemicals",
    companies: [
  ...
  72: {
    name: "Industrial Machinery and Auto Components",
    companies: [
