...
const companies = [
  {
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for cloud security auditing and compliance automation systems.",
    student_perception:
      "Cloud security tooling environment with practical backend and reliability ownership opportunities.",
  },
  {
    company_name: "Escape Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for API posture management and security testing systems.",
    student_perception:
      "API security product with practical backend and performance engineering scope.",
  },
  {
    company_name: "Prompt Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for prompt injection defense and LLM security controls.",
    student_perception:
      "AI security platform with practical backend and data-platform ownership opportunities.",
  },
  {
    company_name: "HiddenLayer India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for machine learning threat detection and model protection systems.",
    student_perception:
      "ML security platform with balanced backend and platform reliability exposure.",
  },
  {
    company_name: "ArmorCode India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for vulnerability intelligence and security program orchestration systems.",
    student_perception:
      "Security orchestration platform with strong backend and reliability engineering opportunities.",
  },
  {
    company_name: "Oxeye India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for cloud-native application risk analysis and remediation.",
    student_perception:
      "Application security product platform with practical backend and distributed systems ownership.",
  },
  {
    company_name: "Reco Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for SaaS risk discovery and identity security posture systems.",
    student_perception:
      "SaaS security platform with practical backend and platform design opportunities.",
  },
  {
    company_name: "Cycode India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for source-code security and software integrity systems.",
    student_perception:
      "Code security product setup with practical backend and reliability exposure.",
  },
  {
    company_name: "Legit Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for software supply-chain risk visibility and mitigation systems.",
    student_perception:
      "Supply-chain security platform with practical backend and systems reliability ownership.",
  },
  {
    company_name: "Scribe Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for software supply-chain integrity and provenance systems.",
    student_perception:
      "Software integrity platform with balanced backend and product systems ownership.",
  },
];
...
writeFileSync(
  "data/companies/companies_batch_40.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_40.json with",
  batch.length,
  "companies",
);
