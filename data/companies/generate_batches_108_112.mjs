...
const batches = {
  108: {
    name: "Cold Storage, Food Logistics, and Warehousing",
    companies: [
  ...
  109: {
    name: "Industrial Safety Equipment, Workwear, and PPE",
    companies: [
      "Mallcom India India",
      "Karam Safety India",
  ...
  110: {
    name: "Glassware, Bottles, and Container Glass",
    companies: [
  ...
  111: {
    name: "Specialty Polymer Additives and Masterbatches",
    companies: [
      "Bajaj Plast India",
  ...
  112: {
    name: "Gearboxes, Industrial Gears, and Transmission Components",
    companies: [
      "Gearbox India India",
