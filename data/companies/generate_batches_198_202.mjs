...
const batches = {
  198: {
    name: "D2C Sleep Solutions, Mattresses, and Bedding",
    companies: [
  ...
  199: {
    name: "D2C Men's Grooming and Personal Care",
    companies: [
      "Beardo Men Grooming",
      "The Man Company D2C",
  ...
  200: {
    name: "D2C Spices, Masalas, and Condiments",
    companies: [
      "MDH Spices Masalas",
  ...
  201: {
    name: "Wind Power Developers, Wind Turbine Manufacturers, and Green Energy",
    companies: [
      "Vestas Wind India",
      "Inox Wind Power",
      "KP Energy Wind",
  ...
  202: {
    name: "D2C Footwear, Athleisure, and Accessories",
    companies: [
      "Red Tape Footwear",
