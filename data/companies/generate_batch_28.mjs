...
const companies = [
  {
    ...
    eligibility:
      "Strong coding and platform fundamentals for LLM tracing, evaluation, and observability systems.",
    student_perception:
      "Developer-tooling AI setup with practical backend and platform reliability ownership.",
  },
  {
    company_name: "Lamini India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and model-platform fundamentals for enterprise LLM fine-tuning and deployment systems.",
    student_perception:
      "Model-platform AI environment with practical backend and performance engineering scope.",
  },
  {
    company_name: "Tavily India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and retrieval-platform fundamentals for real-time AI search and web intelligence systems.",
    student_perception:
      "Search-focused AI engineering setup with practical backend and data-platform ownership opportunities.",
  },
  {
    company_name: "Poolside AI India",
    ...
    eligibility:
      "Strong coding and model-platform fundamentals for code-generation and software automation systems.",
    student_perception:
      "AI-native engineering setup with balanced backend and model-platform reliability exposure.",
  },
  {
    company_name: "Sierra AI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for enterprise conversational AI systems at scale.",
    student_perception:
      "Customer-facing AI product environment with strong backend and reliability engineering opportunities.",
  },
  {
    company_name: "OpenRouter India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for unified AI API routing and reliability systems.",
    student_perception:
      "Platform-first AI product setup with practical backend and distributed systems ownership.",
  },
  {
    company_name: "Humanloop India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for LLM testing, prompt lifecycle, and evaluation systems.",
    student_perception:
      "Developer-tooling AI environment with practical backend and platform design opportunities.",
  },
  {
    company_name: "Gumloop India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for AI automation workflows and agent orchestration systems.",
    student_perception:
      "AI automation product setup with practical backend and platform reliability exposure.",
  },
  {
    company_name: "Maven AGI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for enterprise AI assistant and workflow automation systems.",
    student_perception:
      "Enterprise AI agent product environment with practical backend and systems reliability ownership.",
  },
  {
    company_name: "Decagon AI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for enterprise AI workflow and automation applications.",
    student_perception:
      "Enterprise AI product setup with balanced backend and product systems ownership.",
  },
];
...
writeFileSync(
  "data/companies/companies_batch_28.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_28.json with",
  batch.length,
  "companies",
);
