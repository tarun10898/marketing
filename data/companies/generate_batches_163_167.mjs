...
const batches = {
  163: {
    name: "Commercial Stationery and Office Supplies",
    companies: [
  ...
  164: {
    name: "Premium Leather Footwear and Travel Luggage Brands",
    companies: [
      "Bata Footwear India",
      "Lancer Shoes India",
  ...
  165: {
    name: "Dairy Processing, Cooperatives, and Ice Cream Chains",
    companies: [
  ...
  166: {
    name: "Defense Avionics, Radars, and Navigation Instruments",
    companies: [
  ...
  167: {
    name: "Marine Logistics, Cargo Shipping, and Port Operations",
    companies: [
      "Adani Ports Marine",
