...
const companies = [
  {
    ...
    eligibility:
      "Strong coding and platform fundamentals for authentication, authorization, and developer identity systems.",
    student_perception:
      "Developer-focused infrastructure environment with practical backend and reliability ownership opportunities.",
  },
  {
    company_name: "SigNoz India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and data-platform fundamentals for tracing, metrics, and observability systems at scale.",
    student_perception:
      "Infra-first product environment with practical backend and performance engineering scope.",
  },
  {
    company_name: "Cal.com India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for scheduling APIs and workflow automation systems.",
    student_perception:
      "Developer-product environment with practical backend and data-platform ownership opportunities.",
  },
  {
    company_name: "Novu India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for event-driven notification and messaging infrastructure systems.",
    student_perception:
      "Infrastructure engineering environment with balanced backend and platform reliability exposure.",
  },
  {
    company_name: "Nango India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for SaaS integrations, sync pipelines, and connector platforms.",
    student_perception:
      "Integration-platform product environment with strong backend and reliability engineering opportunities.",
  },
  {
    company_name: "Inngest India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and distributed systems fundamentals for event-driven workflows and durable job orchestration.",
    student_perception:
      "Workflow infrastructure setup with practical backend and distributed systems ownership.",
  },
  {
    company_name: "Trigger.dev India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and systems fundamentals for background jobs, task queues, and workflow execution platforms.",
    student_perception:
      "Developer infrastructure environment with practical backend and platform design opportunities.",
  },
  {
    company_name: "Activepieces India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for no-code/low-code automation and integration workflow systems.",
    student_perception:
      "Automation platform setup with practical backend and reliability exposure.",
  },
  {
    company_name: "Coolify India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and infrastructure fundamentals for developer hosting, deployment, and self-hosted cloud platforms.",
    student_perception:
      "Infrastructure product environment with practical backend and systems reliability ownership.",
  },
  {
    company_name: "OpenSauced India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and data-platform fundamentals for developer analytics and open-source intelligence systems.",
    student_perception:
      "Developer analytics platform setup with balanced backend and product systems ownership.",
  },
];
...
writeFileSync(
  "data/companies/companies_batch_33.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_33.json with",
  batch.length,
  "companies",
);
