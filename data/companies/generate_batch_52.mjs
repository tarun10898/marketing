...
writeFileSync(
  "data/companies/companies_batch_52.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_52.json with",
  batch.length,
  "companies",
);
