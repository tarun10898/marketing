...
const batches = {
  103: {
    name: "Metal Pipes, Tube Manufacturing, and Fittings",
    companies: [
      "Bihar Tubes India",
  ...
  104: {
    name: "Auto Forgings, Castings, and Gear Components",
    companies: [
      "Kalyani Forge India",
  ...
  105: {
    name: "Specialty Plastic Masterbatches and Compounding",
    companies: [
  ...
  106: {
    name: "Dairy Farms, Agro Feed, and Veterinary Products",
    companies: [
      "Suguna Foods India",
  ...
  107: {
    name: "Telecom Cables, Optical Fibers, and Networking Accessories",
    companies: [
      "Gemini Cables India",
