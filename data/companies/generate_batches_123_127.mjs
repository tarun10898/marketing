...
const batches = {
  123: {
    name: "Industrial Gaskets, Seals, and O-Rings",
    companies: [
  ...
  124: {
    name: "Laboratory Chemical Reagents and Diagnostics Kits",
    companies: [
      "Loba Chemie India",
      "SD Fine Chem India",
  ...
  125: {
    name: "Specialized Sensors and Industrial Transducers",
    companies: [
  ...
  126: {
    name: "Machine Tools, CNC Machinery, and Precision Cutting Tools",
    companies: [
  ...
  127: {
    name: "Industrial Valves, Pumps, and Hydraulics Systems",
    companies: [
      "Audco Valves India",
