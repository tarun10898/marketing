...
const batches = {
  203: {
    name: "D2C Packaged Sweets, Mithai, and Desserts",
    companies: [
  ...
  204: {
    name: "Industrial Cranes, Forklifts, and Material Handling Equipment",
    companies: [
  ...
  205: {
    name: "D2C Wellness, Nutritional Supplements, and Health Drinks",
    companies: [
      "Oziva D2C Nutrition",
      "Kapiva D2C Ayurveda",
  ...
  206: {
    name: "Commercial Vehicle Bodies, Buses, and Specialty Vehicles",
    companies: [
  ...
  207: {
    name: "D2C Home Decor, Lighting, and Furnishings",
    companies: [
      "Nestasia D2C Decor",
