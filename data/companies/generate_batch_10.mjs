...
const companies = [
  {
    ...
    category: 'product',
    multiplier: 1.14,
    preferred_skills: ['DSA', 'System Design', 'C/C++', 'Computer Architecture', 'Linux', 'Performance Optimization'],
    eligibility: 'Strong systems programming and architecture fundamentals for performance-critical engineering roles.',
    student_perception: 'Top semiconductor brand with deep core-tech work and strong technical signaling.',
  },
  {
    company_name: 'Marvell India',
    headquarters: 'Santa Clara, California, USA',
    ...
    category: 'product',
    multiplier: 1.09,
    preferred_skills: ['DSA', 'System Design', 'C/C++', 'Computer Architecture', 'Linux', 'Debugging'],
    eligibility: 'Strong coding depth in systems and silicon-adjacent engineering domains.',
    student_perception: 'Strong core-tech environment with high-quality systems engineering exposure.',
  },
  {
    company_name: 'MediaTek India',
    headquarters: 'Hsinchu, Taiwan',
    india_locations: ['Bengaluru', 'Noida'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.05,
    preferred_skills: ['DSA', 'System Design', 'C/C++', 'Embedded Systems', 'Linux', 'Computer Architecture'],
    eligibility: 'Strong low-level coding and debugging fundamentals for embedded and platform roles.',
    student_perception: 'Strong mobile-chip ecosystem exposure with practical systems learning.',
  },
  {
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Java', 'C++', 'Embedded Systems', 'Linux'],
    eligibility: 'Strong coding and systems fundamentals across mobile, platform, and consumer-tech domains.',
    student_perception: 'Large R&D center with broad exposure across product and platform engineering.',
  },
  {
    ...
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'C/C++', 'Embedded Systems', 'Analog-Digital Basics', 'Linux'],
    eligibility: 'Strong fundamentals in embedded systems and low-level software development.',
    student_perception: 'Highly respected core-tech company with strong engineering rigor.',
  },
  {
    company_name: 'Micron Technology India',
    ...
    category: 'product',
    multiplier: 1.06,
    preferred_skills: ['DSA', 'System Design', 'C/C++', 'Python', 'Linux', 'Systems Debugging'],
    eligibility: 'Strong coding and system-level debugging ability for storage and memory software stacks.',
    student_perception: 'Strong semiconductor memory domain exposure with long-term core-tech growth.',
  },
  {
    company_name: 'Broadcom India',
    ...
    category: 'product',
    multiplier: 1.11,
    preferred_skills: ['DSA', 'System Design', 'C/C++', 'Networking', 'Linux', 'Computer Architecture'],
    eligibility: 'Strong systems and networking fundamentals for platform and infrastructure engineering.',
    student_perception: 'Core-tech company with strong systems depth and high technical expectations.',
  },
  {
    company_name: 'Synopsys India',
    headquarters: 'Sunnyvale, California, USA',
    india_locations: ['Bengaluru', 'Hyderabad', 'Noida'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'C++', 'Algorithms', 'EDA Concepts', 'Linux'],
    eligibility: 'Strong algorithmic coding and systems-level engineering fundamentals.',
    student_perception: 'Strong EDA product company with deep engineering and stable growth paths.',
  },
  {
    ...
    category: 'product',
    multiplier: 1.02,
    preferred_skills: ['DSA', 'System Design', 'C++', 'Automation', 'Linux', 'Debugging'],
    eligibility: 'Strong coding and engineering fundamentals for automation and platform roles.',
    student_perception: 'Core engineering company with niche hardware-software integration exposure.',
  },
  {
    company_name: 'Lam Research India',
    ...
    category: 'product',
    multiplier: 1.03,
    preferred_skills: ['DSA', 'System Design', 'C++', 'Automation', 'Linux', 'Systems Thinking'],
    eligibility: 'Strong coding and systems engineering fundamentals for industrial platform software roles.',
    student_perception: 'Solid core-tech environment with practical systems engineering growth.',
  },
];
...
writeFileSync('data/companies/companies_batch_10.json', `${JSON.stringify(batch, null, 2)}\n`, 'utf8');
console.log('Created data/companies/companies_batch_10.json with', batch.length, 'companies');
