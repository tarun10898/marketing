...
const companies = [
  {
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Fintech Systems', 'Cloud', 'Java/TypeScript'],
    eligibility: 'Strong coding and product-platform fundamentals for payments, spend controls, and financial automation systems.',
    student_perception: 'High-ownership fintech product environment with strong backend and platform growth opportunities.',
  },
  {
    company_name: 'Brex India',
    ...
    category: 'product',
    multiplier: 1.09,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Fintech Infrastructure', 'Cloud', 'Java/Go'],
    eligibility: 'Strong coding and reliability fundamentals for financial operations and card-platform products.',
    student_perception: 'Fast-paced fintech engineering setup with meaningful backend ownership and systems design work.',
  },
  {
    company_name: 'Mercury India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Banking APIs', 'Cloud', 'Go/TypeScript'],
    eligibility: 'Strong coding and product-engineering fundamentals for banking and payments infrastructure products.',
    student_perception: 'Developer-friendly fintech product culture with strong backend and platform opportunities.',
  },
  {
    company_name: 'Lattice India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'SaaS Platforms', 'Cloud', 'TypeScript'],
    eligibility: 'Strong coding and product-platform fundamentals for HR and performance management systems.',
    student_perception: 'Solid B2B SaaS engineering culture with practical backend and platform ownership.',
  },
  {
    company_name: 'Glean India',
    ...
    category: 'product',
    multiplier: 1.09,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Search Systems', 'Cloud', 'Python/Java'],
    eligibility: 'Strong coding and retrieval-platform fundamentals for enterprise knowledge and AI search products.',
    student_perception: 'Strong product engineering setup with meaningful backend and data-platform exposure.',
  },
  {
    company_name: 'Clari India',
    ...
    category: 'product',
    multiplier: 1.09,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Data Platforms', 'Cloud', 'Java/TypeScript'],
    eligibility: 'Strong coding and analytics-platform fundamentals for revenue operations and forecasting products.',
    student_perception: 'Enterprise SaaS environment with balanced backend ownership and product impact.',
  },
  {
    company_name: 'Samsara India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'IoT Platforms', 'Cloud', 'Java/Go'],
    eligibility: 'Strong coding and distributed systems fundamentals for connected operations and telemetry platforms.',
    student_perception: 'Strong systems-oriented product environment with practical backend and data pipeline exposure.',
  },
  {
    company_name: 'OpenPhone India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Realtime Communication', 'Cloud', 'TypeScript'],
    eligibility: 'Strong coding and communication-platform fundamentals for business calling and collaboration products.',
    student_perception: 'SaaS product company with practical backend ownership and service reliability exposure.',
  },
  {
    company_name: 'RudderStack India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Event Streaming', 'Cloud', 'Go/Java'],
    eligibility: 'Strong coding and data-pipeline fundamentals for customer data and event-routing platforms.',
    student_perception: 'Data-infra oriented engineering culture with strong backend and distributed systems practice.',
  },
  {
    company_name: 'Chainguard India',
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Security Engineering', 'Cloud', 'Go'],
    eligibility: 'Strong coding and security-platform fundamentals for trusted software supply-chain infrastructure products.',
    student_perception: 'Security-focused product engineering environment with solid backend and platform reliability opportunities.',
  },
];
...
writeFileSync('data/companies/companies_batch_22.json', `${JSON.stringify(batch, null, 2)}\n`, 'utf8');
console.log('Created data/companies/companies_batch_22.json with', batch.length, 'companies');
