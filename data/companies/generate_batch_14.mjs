...
const companies = [
  {
    ...
    category: 'product',
    multiplier: 1.18,
    preferred_skills: ['DSA', 'System Design', 'Databases', 'Distributed Systems', 'Cloud', 'Java/Go'],
    eligibility: 'Strong systems and backend fundamentals for distributed database product engineering.',
    student_perception: 'Strong developer data-platform company with deep backend engineering exposure.',
  },
  {
    company_name: 'Couchbase India',
    ...
    category: 'product',
    multiplier: 1.1,
    preferred_skills: ['DSA', 'System Design', 'Databases', 'Distributed Systems', 'Cloud', 'C++/Go'],
    eligibility: 'Strong coding and distributed data-system fundamentals for database product teams.',
    student_perception: 'Solid database product engineering path with strong systems depth.',
  },
  {
    company_name: 'Neo4j India',
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Graph Databases', 'Java', 'Distributed Systems', 'Cloud'],
    eligibility: 'Strong backend and data-modeling fundamentals for graph data platform engineering.',
    student_perception: 'Good niche database engineering environment with practical systems challenges.',
  },
  {
    company_name: 'Yugabyte India',
    ...
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'Distributed Databases', 'Go', 'C++', 'Cloud'],
    eligibility: 'Strong coding and distributed database fundamentals for cloud-native data systems.',
    student_perception: 'High-growth distributed database company with strong core systems learning.',
  },
  {
    ...
    category: 'product',
    multiplier: 1.1,
    preferred_skills: ['DSA', 'System Design', 'Frontend Performance', 'Edge Functions', 'Cloud', 'JavaScript/TypeScript'],
    eligibility: 'Strong full-stack and platform fundamentals for developer productivity and deployment infrastructure.',
    student_perception: 'Modern developer-platform company with strong frontend and platform engineering relevance.',
  },
  {
    company_name: 'PagerDuty India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'SRE', 'Observability', 'Cloud', 'Go'],
    eligibility: 'Strong coding and reliability engineering fundamentals for incident response platforms.',
    student_perception: 'Strong reliability-focused product environment with meaningful production impact.',
  },
  {
    company_name: 'CircleCI India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.06,
    preferred_skills: ['DSA', 'System Design', 'CI/CD', 'Cloud', 'DevOps', 'Go'],
    eligibility: 'Strong coding and platform fundamentals for CI/CD and developer tooling systems.',
    student_perception: 'Developer productivity platform with practical infrastructure and tooling scope.',
  },
  {
    company_name: 'CloudBees India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.04,
    preferred_skills: ['DSA', 'System Design', 'DevOps', 'Jenkins Ecosystem', 'Cloud', 'Java'],
    eligibility: 'Strong coding and software delivery platform fundamentals for enterprise CI/CD products.',
    student_perception: 'Stable DevOps product space with good platform engineering learning opportunities.',
  },
  {
    company_name: 'Temporal Technologies India',
    ...
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'Distributed Systems', 'Workflow Orchestration', 'Go/Java', 'Cloud'],
    eligibility: 'Strong backend and distributed-systems fundamentals for workflow runtime platforms.',
    student_perception: 'Strong infrastructure product with high-quality distributed systems challenges.',
  },
  {
    company_name: 'Sumo Logic India',
    ...
    category: 'product',
    multiplier: 1.06,
    preferred_skills: ['DSA', 'System Design', 'Observability', 'Data Pipelines', 'Cloud', 'Java'],
    eligibility: 'Strong coding and data-platform fundamentals for observability analytics products.',
    student_perception: 'Solid observability engineering environment with practical large-scale system exposure.',
  },
];
...
writeFileSync('data/companies/companies_batch_14.json', `${JSON.stringify(batch, null, 2)}\n`, 'utf8');
console.log('Created data/companies/companies_batch_14.json with', batch.length, 'companies');
