...
const batches = {
  178: {
    name: "Fertilizer Cooperatives and Soil Nutrition",
    companies: [
  ...
  179: {
    name: "Direct-to-Consumer (D2C) Footwear, Comfort wear, and Accessories",
    companies: [
      "Yoho D2C Footwear",
      "Neeman's D2C Shoes",
      "Flatheads D2C Shoes",
  ...
  180: {
    name: "Industrial Automation, PLCs, and SCADA Systems",
    companies: [
  ...
  181: {
    name: "Industrial Paint, Powder Coatings, and Protective Linings",
    companies: [
  ...
  182: {
    name: "Mining Equipment, Heavy Excavators, and Coal Processing",
    companies: [
