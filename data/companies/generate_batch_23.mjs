...
const companies = [
  {
    ...
    category: 'product',
    multiplier: 1.14,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'LLM Infrastructure', 'Cloud', 'Python'],
    eligibility: 'Strong coding and AI-platform fundamentals for reliable large-scale model serving and tooling systems.',
    student_perception: 'High-impact AI product engineering environment with deep backend and platform ownership opportunities.',
  },
  {
    company_name: 'Cohere India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'NLP Systems', 'Cloud', 'Python/Go'],
    eligibility: 'Strong coding and ML-platform fundamentals for language model inference and enterprise AI systems.',
    student_perception: 'Applied AI engineering setup with strong backend and data-platform depth.',
  },
  {
    company_name: 'Perplexity India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Search Infrastructure', 'Cloud', 'Python'],
    eligibility: 'Strong coding and retrieval-platform fundamentals for AI-assisted search and answer systems.',
    student_perception: 'Fast-growing AI/search product environment with practical backend and systems ownership.',
  },
  {
    company_name: 'Mistral AI India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Model Serving', 'Cloud', 'Python/C++'],
    eligibility: 'Strong coding and model-platform fundamentals for efficient open model training and inference systems.',
    student_perception: 'Research-to-production AI engineering environment with meaningful backend systems exposure.',
  },
  {
    company_name: 'Together AI India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.11,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'GPU Infrastructure', 'Cloud', 'Python'],
    eligibility: 'Strong coding and AI infrastructure fundamentals for model training, serving, and inference orchestration.',
    student_perception: 'AI infrastructure focused engineering culture with strong backend and platform depth.',
  },
  {
    company_name: 'LangChain India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.1,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Agent Frameworks', 'Cloud', 'Python/TypeScript'],
    eligibility: 'Strong coding and platform fundamentals for LLM application frameworks and orchestration tooling.',
    student_perception: 'Developer-first AI tooling environment with practical backend and platform ownership.',
  },
  {
    company_name: 'Weights & Biases India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'ML Tooling', 'Cloud', 'Python/Go'],
    eligibility: 'Strong coding and data-platform fundamentals for ML experiment tracking and model lifecycle tooling.',
    student_perception: 'ML engineering-focused product setup with strong backend and platform opportunities.',
  },
  {
    company_name: 'Modal India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Serverless Systems', 'Cloud', 'Python/TypeScript'],
    eligibility: 'Strong coding and cloud runtime fundamentals for scalable serverless compute and AI workloads.',
    student_perception: 'Modern infrastructure product environment with practical backend and reliability engineering depth.',
  },
  {
    company_name: 'Replicate India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Model Inference APIs', 'Cloud', 'Python/Go'],
    eligibility: 'Strong coding and API-platform fundamentals for production model inference and developer integrations.',
    student_perception: 'AI developer platform setup with strong backend and production reliability exposure.',
  },
  {
    company_name: 'Runway India',
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Media AI Systems', 'Cloud', 'Python'],
    eligibility: 'Strong coding and media-platform fundamentals for AI-assisted video generation and creative tooling systems.',
    student_perception: 'Creative AI engineering environment with practical backend and product systems ownership.',
  },
];
...
writeFileSync('data/companies/companies_batch_23.json', `${JSON.stringify(batch, null, 2)}\n`, 'utf8');
console.log('Created data/companies/companies_batch_23.json with', batch.length, 'companies');
