...
const batches = {
  183: {
    name: "Direct-to-Consumer (D2C) Organic Foods and Health Snacks",
    companies: [
  ...
  184: {
    name: "Heavy Electrical Gears, Switchgears, and Panel Boards",
    companies: [
  ...
  185: {
    name: "Commercial Printing ink, Pigments, and Masterbatches",
    companies: [
  ...
  186: {
    name: "Solar Power EPC, Rooftop Solar, and Grid Integration",
    companies: [
  ...
  187: {
    name: "Direct-to-Consumer (D2C) Luggage, Backpacks, and Travel Gear",
    companies: [
