...
const companies = [
  {
    ...
    eligibility:
      "Strong coding and model-platform fundamentals for speech synthesis and expressive voice generation systems.",
    student_perception:
      "Applied voice AI platform environment with practical backend and reliability ownership opportunities.",
  },
  {
    company_name: "Pika Labs India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and media-platform fundamentals for AI video creation and editing systems at scale.",
    student_perception:
      "Creative AI product environment with practical backend and performance engineering scope.",
  },
  {
    company_name: "CodeSee India",
    ...
    eligibility:
      "Strong coding and developer-platform fundamentals for code mapping, architecture insight, and review automation systems.",
    student_perception:
      "Developer-tooling environment with practical backend and data-platform ownership opportunities.",
  },
  {
    company_name: "StackBlitz India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for browser-based development environments and cloud runtime tooling.",
    student_perception:
      "Developer-platform engineering environment with balanced backend and platform reliability exposure.",
  },
  {
    company_name: "Murf AI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and media-platform fundamentals for AI voice generation and content production systems.",
    student_perception:
      "Audio AI product environment with strong backend and reliability engineering opportunities.",
  },
  {
    company_name: "Raycast India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for developer productivity, AI command workflows, and extensions.",
    student_perception:
      "Developer productivity setup with practical backend and distributed systems ownership.",
  },
  {
    company_name: "Warp AI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and developer-platform fundamentals for terminal automation and AI-assisted workflow systems.",
    student_perception:
      "Developer tooling environment with practical backend and platform design opportunities.",
  },
  {
    company_name: "Zed Industries India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and systems fundamentals for high-performance code editor and collaboration runtime systems.",
    student_perception:
      "Systems-focused developer platform setup with practical backend and reliability exposure.",
  },
  {
    company_name: "Cline Labs India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for autonomous coding assistant and IDE workflow systems.",
    student_perception:
      "Agentic developer-tooling environment with practical backend and systems reliability ownership.",
  },
  {
    company_name: "tldraw India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    preferred_skills: [
      ...
      "System Design",
      "Backend Engineering",
      "Collaborative Canvas Systems",
      "Cloud",
      "Python",
    ],
    eligibility:
      "Strong coding and product-platform fundamentals for collaborative whiteboard and AI-assisted diagram systems.",
    student_perception:
      "Collaborative product-platform setup with balanced backend and product systems ownership.",
  },
];
...
writeFileSync(
  "data/companies/companies_batch_32.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_32.json with",
  batch.length,
  "companies",
);
