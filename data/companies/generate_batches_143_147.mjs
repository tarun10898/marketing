...
const batches = {
  143: {
    name: "Specialty Lubricants, Engine Oils, and Industrial Greases",
    companies: [
  ...
  144: {
    name: "Agrochemicals, Pesticides, and Insecticides",
    companies: [
  ...
  145: {
    name: "Industrial Adhesives, Sealants, and Tapes",
    companies: [
  ...
  146: {
    name: "Bicycle Manufacturing, E-Bikes, and Fitness Equipment",
    companies: [
      "Hero Cycles India",
      "TI Cycles India",
      "Atlas Cycles India",
  ...
  147: {
    name: "Supermarkets, Hypermarkets, and Grocery Retail Chains",
    companies: [
