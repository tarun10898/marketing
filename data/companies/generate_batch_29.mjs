...
const companies = [
  {
    ...
    eligibility:
      "Strong coding and media-platform fundamentals for AI photo editing and generation systems.",
    student_perception:
      "Creative AI product setup with practical backend and platform reliability ownership.",
  },
  {
    company_name: "Modal Labs India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and distributed systems fundamentals for serverless compute and AI workload platforms.",
    student_perception:
      "Infra-first AI environment with practical backend and performance engineering scope.",
  },
  {
    company_name: "OctoAI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and infrastructure-platform fundamentals for production AI inference and optimization systems.",
    student_perception:
      "AI platform engineering setup with practical backend and data-platform ownership opportunities.",
  },
  {
    company_name: "Krea AI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and media-platform fundamentals for generative design and image/video AI systems.",
    student_perception:
      "Creative AI engineering environment with balanced backend and platform reliability exposure.",
  },
  {
    company_name: "Resemble AI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and model-platform fundamentals for voice synthesis and conversational media systems.",
    student_perception:
      "Applied voice AI product environment with strong backend and reliability engineering opportunities.",
  },
  {
    company_name: "PlayHT India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for low-latency voice generation and delivery systems.",
    student_perception:
      "Audio AI product setup with practical backend and distributed systems ownership.",
  },
  {
    company_name: "Typeface AI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for enterprise generative content systems.",
    student_perception:
      "Enterprise creative AI environment with practical backend and platform design opportunities.",
  },
  {
    company_name: "Aporia India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for ML monitoring, drift detection, and reliability systems.",
    student_perception:
      "ML ops product setup with practical backend and platform reliability exposure.",
  },
  {
    company_name: "MindsDB India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and data-platform fundamentals for AI-native database and query automation systems.",
    student_perception:
      "Data-first AI product environment with practical backend and systems reliability ownership.",
  },
  {
    company_name: "Vapi India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for voice-agent orchestration and telephony automation systems.",
    student_perception:
      "Voice-agent AI product setup with balanced backend and product systems ownership.",
  },
];
...
writeFileSync(
  "data/companies/companies_batch_29.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_29.json with",
  batch.length,
  "companies",
);
