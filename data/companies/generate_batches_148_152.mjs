...
const batches = {
  148: {
    name: "Building Automation, Elevators, and Escalators",
    companies: [
  ...
  151: {
    name: "Airport Operations and Aviation Support Services",
    companies: [
      "GMR Airports India",
  ...
  152: {
    name: "Industrial Generators and Power Backup Systems",
    companies: [
      "Captiva Power India",
