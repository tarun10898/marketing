...
const companies = [
  {
    ...
    eligibility:
      "Strong coding and platform fundamentals for production debugging, observability, and runtime instrumentation systems.",
    student_perception:
      "Developer-platform environment with practical backend and reliability ownership opportunities.",
  },
  {
    company_name: "Airtop India",
    ...
    eligibility:
      "Strong coding and platform fundamentals for browser automation and AI workflow infrastructure systems.",
    student_perception:
      "Automation-first AI environment with practical backend and performance engineering scope.",
  },
  {
    company_name: "Cartwheel AI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and media-platform fundamentals for AI-assisted animation and character workflow systems.",
    student_perception:
      "Creative AI engineering setup with practical backend and data-platform ownership opportunities.",
  },
  {
    company_name: "Martian AI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and model-platform fundamentals for autonomous agent and reasoning workflow systems.",
    student_perception:
      "AI-native engineering environment with balanced backend and platform reliability exposure.",
  },
  {
    company_name: "Sana AI India",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for enterprise search, knowledge, and assistant systems.",
    student_perception:
      "Enterprise AI product environment with strong backend and reliability engineering opportunities.",
  },
  {
    company_name: "Factory AI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and model-platform fundamentals for AI software engineering and automation systems.",
    student_perception:
      "Agentic software product setup with practical backend and distributed systems ownership.",
  },
  {
    company_name: "Captions AI India",
    ...
    eligibility:
      "Strong coding and media-platform fundamentals for AI video editing and generation systems.",
    student_perception:
      "Consumer media AI environment with practical backend and platform design opportunities.",
  },
  {
    company_name: "Gradient AI India",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for enterprise AI decisioning and risk systems.",
    student_perception:
      "Applied enterprise AI setup with practical backend and platform reliability exposure.",
  },
  {
    company_name: "Cresta AI India",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for real-time assistant and customer experience AI systems.",
    student_perception:
      "Customer AI product environment with practical backend and systems reliability ownership.",
  },
  {
    company_name: "Daytona India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for cloud development environment and automation tooling systems.",
    student_perception:
      "Developer-tooling platform setup with balanced backend and product systems ownership.",
  },
];
...
writeFileSync(
  "data/companies/companies_batch_30.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_30.json with",
  batch.length,
  "companies",
);
