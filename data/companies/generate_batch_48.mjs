...
const companyNames = [
  ...
  "Route Mobile India",
  "Tanla Platforms India",
  "Infobeans Technologies India",
  "TatvaSoft India",
  "Hidden Brains India",
];
...
const companies = companyNames.map((companyName) => ({
  ...
  eligibility:
    "Graduates with basic programming knowledge, logical reasoning, and communication skills suitable for enterprise support and client consulting workflows.",
  student_perception:
    "Large-scale recruiter providing baseline industry entry and learning platform for early careers.",
}));
...
writeFileSync(
  "data/companies/companies_batch_48.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_48.json with",
  batch.length,
  "companies",
);
