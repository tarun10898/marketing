...
const companies = [
  {
    ...
    eligibility: 'Strong systems fundamentals, coding depth, and hardware-software integration mindset.',
    student_perception: 'Strong semiconductor engineering brand with high technical depth in core systems.',
  },
  {
    company_name: 'Cadence Design Systems',
    headquarters: 'San Jose, California, USA',
    india_locations: ['Noida', 'Bengaluru', 'Pune'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.13,
    ...
    student_perception: 'Strong niche product company with deep engineering and stable growth paths.',
  },
  {
    company_name: 'Arm India',
    ...
    category: 'product',
    multiplier: 1.2,
    preferred_skills: ['DSA', 'System Design', 'C/C++', 'Computer Architecture', 'Embedded Systems', 'Linux'],
    eligibility: 'Strong low-level coding and architecture fundamentals with problem-solving rigor.',
    student_perception: 'High prestige for core systems roles with strong long-term technical signaling.',
  },
  {
    company_name: 'NXP Semiconductors India',
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'C/C++', 'Embedded Systems', 'Linux', 'Debugging'],
    eligibility: 'Strong systems programming, debugging, and product-quality engineering foundations.',
    student_perception: 'Good hardware-software product environment with consistent engineering depth.',
  },
  {
    ...
    category: 'product',
    multiplier: 1.14,
    preferred_skills: ['DSA', 'System Design', 'Java', 'Distributed Systems', 'Data Platforms', 'SQL'],
    eligibility: 'Strong coding and analytics-platform engineering fundamentals.',
    student_perception: 'High-growth data product company with strong ownership and platform depth.',
  },
  {
    company_name: 'Juspay',
    ...
    category: 'product',
    multiplier: 1.07,
    preferred_skills: ['DSA', 'System Design', 'Java', 'Distributed Systems', 'Payments Domain', 'SQL'],
    eligibility: 'Strong coding fundamentals and reliability-focused backend engineering aptitude.',
    student_perception: 'Strong fintech infrastructure brand with meaningful early-career ownership.',
  },
  {
    company_name: 'Siemens EDA India',
    headquarters: 'Wilsonville, Oregon, USA',
    india_locations: ['Noida', 'Pune', 'Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.06,
    preferred_skills: ['DSA', 'System Design', 'C++', 'Algorithms', 'Linux', 'Debugging'],
    eligibility: 'Strong coding and systems fundamentals with product-quality engineering mindset.',
    student_perception: 'Respected engineering niche with solid long-term core-tech learning.',
  },
  {
    company_name: 'Nagarro',
    headquarters: 'Munich, Germany',
    india_locations: ['Gurugram', 'Noida', 'Bengaluru'],
    type: 'Service',
    tier: 'Tier 3',
    category: 'service',
    multiplier: 0.68,
    preferred_skills: ['Programming Basics', 'Aptitude', 'Fundamentals', 'Communication'],
    eligibility: 'Service-delivery fresher hiring with coding fundamentals and communication checks.',
    student_perception: 'Service-track option where project type strongly affects growth trajectory.',
  },
  {
    company_name: 'UST',
    headquarters: 'Aliso Viejo, California, USA',
    india_locations: ['Thiruvananthapuram', 'Kochi', 'Bengaluru'],
    type: 'Service',
    tier: 'Tier 3',
    category: 'service',
    multiplier: 0.69,
    preferred_skills: ['Programming Basics', 'Aptitude', 'Fundamentals', 'Communication'],
    eligibility: 'Entry-level engineering hiring with coding basics and aptitude filters.',
    student_perception: 'Moderate service option where outcomes depend on project quality and mobility.',
  },
  {
    ...
    multiplier: 0.62,
    preferred_skills: ['Programming Basics', 'Aptitude', 'Fundamentals', 'Communication'],
    eligibility: 'Mass-entry service hiring with baseline coding and aptitude evaluation.',
    student_perception: 'Fallback route where sustained upskilling is key for upward mobility.',
  },
];
...
writeFileSync('data/companies/companies_batch_9.json', `${JSON.stringify(batch, null, 2)}\n`, 'utf8');
console.log('Created data/companies/companies_batch_9.json with', batch.length, 'companies');
