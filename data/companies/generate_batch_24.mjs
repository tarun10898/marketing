...
const companies = [
  {
    ...
    category: 'product',
    multiplier: 1.1,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Healthcare AI', 'Cloud', 'Python'],
    eligibility: 'Strong coding and ML-platform fundamentals for clinical documentation and healthcare AI systems.',
    student_perception: 'Applied AI product environment with meaningful backend and data-platform ownership.',
  },
  {
    company_name: 'Scale AI India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Data Platforms', 'Cloud', 'Python/Go'],
    eligibility: 'Strong coding and data-platform fundamentals for AI data pipelines and model operations systems.',
    student_perception: 'High-growth AI infrastructure setup with strong backend and platform engineering depth.',
  },
  {
    company_name: 'Writer India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'LLM Applications', 'Cloud', 'Python/TypeScript'],
    eligibility: 'Strong coding and product-platform fundamentals for enterprise generative AI tooling and workflows.',
    student_perception: 'Practical AI product engineering culture with balanced backend and platform opportunities.',
  },
  {
    company_name: 'Harvey India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Legal AI Systems', 'Cloud', 'Python'],
    eligibility: 'Strong coding and product-platform fundamentals for AI-driven legal workflow and document systems.',
    student_perception: 'Domain-focused AI engineering setup with strong backend and platform ownership.',
  },
  {
    company_name: 'Axiom AI India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.09,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Agent Systems', 'Cloud', 'Python/TypeScript'],
    eligibility: 'Strong coding and AI-platform fundamentals for autonomous workflow and agent orchestration systems.',
    student_perception: 'Modern AI product engineering environment with practical backend and systems exposure.',
  },
  {
    company_name: 'Poolside India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.1,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Code Generation Systems', 'Cloud', 'Python'],
    eligibility: 'Strong coding and model-platform fundamentals for AI-assisted software development systems.',
    student_perception: 'AI-first developer tooling culture with strong backend and platform engineering scope.',
  },
  {
    company_name: 'Sierra India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Conversational AI', 'Cloud', 'Python'],
    eligibility: 'Strong coding and AI-platform fundamentals for conversational systems and customer interaction products.',
    student_perception: 'Applied AI product environment with practical backend and reliability engineering opportunities.',
  },
  {
    company_name: 'Replit India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Developer Platforms', 'Cloud', 'TypeScript/Python'],
    eligibility: 'Strong coding and product-platform fundamentals for cloud IDE and collaborative development systems.',
    student_perception: 'Developer-centric product setup with strong backend and platform ownership opportunities.',
  },
  {
    company_name: 'Lambda Labs India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    ...
    eligibility: 'Strong coding and infrastructure-platform fundamentals for AI compute and model training systems.',
    student_perception: 'AI infrastructure-focused engineering setup with practical backend and reliability depth.',
  },
  {
    company_name: 'Character.AI India',
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'LLM Product Systems', 'Cloud', 'Python'],
    eligibility: 'Strong coding and AI-platform fundamentals for conversational model products and user-scale systems.',
    student_perception: 'Consumer AI product environment with strong backend and platform learning opportunities.',
  },
];
...
writeFileSync('data/companies/companies_batch_24.json', `${JSON.stringify(batch, null, 2)}\n`, 'utf8');
console.log('Created data/companies/companies_batch_24.json with', batch.length, 'companies');
