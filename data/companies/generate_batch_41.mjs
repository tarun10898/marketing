...
const companies = [
  ...
  {
    company_name: "Relyance AI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
  ...
  {
    company_name: "Noma Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
  ...
  {
    company_name: "Lasso Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
  ...
  {
    company_name: "Pillar Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
  ...
  {
    company_name: "Upwind Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
  ...
  {
    company_name: "Trail Security India",
  ...
  {
    company_name: "Apiiro Labs India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
  ...
  {
    company_name: "Sola Security India",
    headquarters: "Tel Aviv, Israel",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
  ...
  {
    company_name: "Armo Security India",
    headquarters: "Tel Aviv, Israel",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
...
writeFileSync(
  "data/companies/companies_batch_41.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_41.json with",
  batch.length,
  "companies",
);
