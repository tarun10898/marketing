...
const companies = [
  {
    ...
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['Java', 'SQL', 'DSA', 'System Design', 'Cloud', 'Distributed Systems'],
    eligibility: 'Strong coding fundamentals and product engineering mindset.',
    student_perception: 'Strong product MNC with solid pay and long-term growth opportunities.'
  },
  {
    company_name: 'SAP Labs',
    headquarters: 'Walldorf, Germany',
    india_locations: ['Bengaluru', 'Pune', 'Gurgaon'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.06,
    preferred_skills: ['Java', 'Spring', 'SQL', 'Cloud', 'DSA', 'System Design'],
    eligibility: 'Good coding and enterprise platform fundamentals.',
    student_perception: 'Well-regarded product engineering environment with stable growth.'
  },
  {
    company_name: 'VMware',
    ...
    category: 'product',
    multiplier: 1.1,
    preferred_skills: ['Java', 'C++', 'Distributed Systems', 'Cloud', 'DSA', 'System Design'],
    eligibility: 'Strong systems and platform engineering basics.',
    student_perception: 'Good product brand with strong infra and platform learning opportunities.'
  },
  {
    company_name: 'Cisco',
    headquarters: 'San Jose, California, USA',
    india_locations: ['Bengaluru', 'Chennai', 'Pune'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.04,
    preferred_skills: ['Networking', 'C/C++', 'Python', 'DSA', 'System Design', 'Linux'],
    eligibility: 'Solid coding and networking/system fundamentals.',
    student_perception: 'Strong engineering company with good domain depth and stability.'
  },
  {
    company_name: 'TCS',
    ...
    category: 'service',
    multiplier: 0.66,
    preferred_skills: ['Programming Basics', 'SQL Basics', 'Aptitude', 'Communication'],
    eligibility: 'Broad fresher intake with foundational coding and aptitude requirements.',
    student_perception: 'Safe fallback option with stable entry, but growth depends on reskilling.'
  },
  {
    ...
    category: 'service',
    multiplier: 0.65,
    preferred_skills: ['Programming Basics', 'Problem Solving', 'Aptitude', 'Communication'],
    eligibility: 'Large fresher hiring with baseline coding and aptitude checks.',
    student_perception: 'Entry path for freshers, with transition potential through sustained upskilling.'
  },
  {
    company_name: 'Wipro',
    headquarters: 'Bengaluru, India',
    ...
    category: 'service',
    multiplier: 0.63,
    preferred_skills: ['Coding Basics', 'Aptitude', 'Communication', 'Fundamentals'],
    eligibility: 'Foundational hiring pipeline with basic coding and aptitude rounds.',
    student_perception: 'Fallback role path; growth improves with strong reskilling strategy.'
  },
  {
    ...
    category: 'service',
    multiplier: 0.67,
    preferred_skills: ['Coding Basics', 'Aptitude', 'SQL Basics', 'Communication'],
    eligibility: 'Mass fresher hiring with basic coding and analytical checks.',
    student_perception: 'Common fallback with moderate entry barriers and skill-based growth scope.'
  },
  {
    ...
    category: 'service',
    multiplier: 0.69,
    preferred_skills: ['Programming Basics', 'Aptitude', 'Communication', 'Client Fundamentals'],
    eligibility: 'Broad hiring pipeline with basic coding and communication-heavy evaluation.',
    student_perception: 'Stable fallback route; role quality varies significantly by project allocation.'
  },
  {
    ...
    category: 'service',
    multiplier: 0.64,
    preferred_skills: ['Coding Basics', 'Aptitude', 'Fundamentals', 'Communication'],
    eligibility: 'Entry-level service hiring with baseline coding and aptitude tests.',
    student_perception: 'Fallback opportunity where progress depends heavily on individual upskilling effort.'
  }
];
...
writeFileSync('data/companies/companies_batch_4.json', `${JSON.stringify(batch, null, 2)}\n`, 'utf8');
console.log('Created data/companies/companies_batch_4.json with', batch.length, 'companies');
