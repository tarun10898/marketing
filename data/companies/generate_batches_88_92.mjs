...
const batches = {
  88: {
    name: "Specialized Bearings and Precision Components",
    companies: [
      "SKF India India",
      "Timken India India",
  ...
  89: {
    name: "Industrial Filters, Valves, and Pumps",
    companies: [
  ...
  90: {
    name: "Electrical Switchgears and Relays",
    companies: [
  ...
  91: {
    name: "Luxury Hotels, Heritage Resorts, and Clubs",
    companies: [
  ...
  92: {
    name: "Packaging Films, Laminates, and Bags",
    companies: [
