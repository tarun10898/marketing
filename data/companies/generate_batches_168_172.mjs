...
const batches = {
  168: {
    name: "Agricultural Tractors and Farm Equipment",
    companies: [
  ...
  169: {
    name: "Spices, Condiments, and Flour Mills",
    companies: [
      "MTR Foods Masalas",
      "Gits Foods Spices",
      "Roopak Masala India",
  ...
  170: {
    name: "Electric Motor and Alternator Manufacturers",
    companies: [
  ...
  171: {
    name: "Industrial Gears, Gearboxes, and Speed Reducers",
    companies: [
      "Sears Gears India",
  ...
  172: {
    name: "National Highway EPC and Bridge Developers",
    companies: [
      "Dilip Buildcon EPC",
      "Ashoka Buildcon EPC",
