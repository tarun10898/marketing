...
const companies = [
  {
    ...
    category: 'product',
    multiplier: 1.28,
    preferred_skills: ['DSA', 'System Design', 'Distributed Systems', 'Spark', 'Cloud', 'Python'],
    eligibility: 'Strong distributed systems and data-platform engineering fundamentals.',
    student_perception: 'Top-tier data platform company with high engineering bar and strong growth trajectory.',
  },
  {
    company_name: 'Snowflake India',
    ...
    category: 'product',
    multiplier: 1.25,
    preferred_skills: ['DSA', 'System Design', 'Distributed Systems', 'Databases', 'Cloud', 'C++'],
    eligibility: 'Strong systems and cloud data-warehouse engineering fundamentals.',
    student_perception: 'High-quality cloud data engineering environment with strong compensation signals.',
  },
  {
    ...
    category: 'product',
    multiplier: 1.3,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Distributed Systems', 'Payments Domain', 'Java'],
    eligibility: 'Strong backend and reliability mindset for global payments infrastructure.',
    student_perception: 'Elite fintech infrastructure company with strong technical ownership.',
  },
  {
    ...
    category: 'product',
    multiplier: 1.14,
    preferred_skills: ['DSA', 'System Design', 'Distributed Systems', 'Cloud', 'Java', 'Go'],
    eligibility: 'Strong systems and cloud data-protection engineering fundamentals.',
    student_perception: 'Strong infra product environment with high-impact backend challenges.',
  },
  {
    company_name: 'Cloudera India',
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Data Engineering', 'Distributed Systems', 'Java', 'Cloud'],
    eligibility: 'Strong coding and data-platform fundamentals with distributed systems depth.',
    student_perception: 'Good data infrastructure engineering path with practical platform exposure.',
  },
  {
    company_name: 'Elastic India',
    ...
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'Distributed Systems', 'Search Technologies', 'Java', 'Cloud'],
    eligibility: 'Strong backend and search-platform engineering fundamentals.',
    student_perception: 'Strong developer tooling and search stack engineering environment.',
  },
  {
    company_name: 'Confluent India',
    headquarters: 'Mountain View, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.16,
    preferred_skills: ['DSA', 'System Design', 'Distributed Systems', 'Kafka', 'Java', 'Cloud'],
    eligibility: 'Strong distributed systems and event-streaming platform fundamentals.',
    student_perception: 'Strong infra engineering exposure in real-time data systems.',
  },
  {
    company_name: 'Redis India',
    headquarters: 'Mountain View, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.14,
    preferred_skills: ['DSA', 'System Design', 'Distributed Systems', 'C/C++', 'Linux', 'Performance Engineering'],
    eligibility: 'Strong systems coding and low-latency data-platform engineering fundamentals.',
    student_perception: 'Core infra product environment with strong backend and systems depth.',
  },
  {
    company_name: 'Harness India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'DevOps', 'Cloud', 'Java', 'Distributed Systems'],
    eligibility: 'Strong coding and platform engineering basics for CI/CD and cloud automation domains.',
    student_perception: 'Modern developer platform company with practical ownership opportunities.',
  },
  {
    company_name: 'GitLab India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.1,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Cloud', 'Ruby/Go', 'DevSecOps'],
    eligibility: 'Strong backend and platform thinking for developer productivity and DevSecOps workflows.',
    student_perception: 'Strong developer tooling company with broad engineering impact areas.',
  },
];
...
writeFileSync('data/companies/companies_batch_11.json', `${JSON.stringify(batch, null, 2)}\n`, 'utf8');
console.log('Created data/companies/companies_batch_11.json with', batch.length, 'companies');
