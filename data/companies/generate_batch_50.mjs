...
const companyNames = [
  ...
  "Tata Projects India",
  "Tata Power India",
  "Macrotech Developers India",
  "Oberoi Realty India",
  "Prestige Estates Projects India",
  "Sobha India",
  "Brigade Enterprises India",
  "GMR Infrastructure India",
  "Adani Ports and SEZ India",
  "Adani Enterprises India",
  "NHPC India",
  "SJVN India",
  "Power Grid Corporation of India",
  "IRCON International India",
  "Dilip Buildcon India",
  "NCC India",
  "KEC International India",
  "Ashoka Buildcon India",
  "Sadbhav Engineering India",
  "PNC Infratech India",
  "L&T Infrastructure Development Projects India",
...
writeFileSync(
  "data/companies/companies_batch_50.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_50.json with",
  batch.length,
  "companies",
);
