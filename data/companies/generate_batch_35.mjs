...
const companies = [
  {
    ...
    eligibility:
      "Strong coding and platform fundamentals for incident response automation and reliability tooling systems.",
    student_perception:
      "SRE-focused product platform with practical backend and reliability ownership opportunities.",
  },
  {
    company_name: "Incident.io India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for incident orchestration, on-call workflows, and reliability operations systems.",
    student_perception:
      "Reliability engineering environment with practical backend and performance engineering scope.",
  },
  {
    company_name: "FireHydrant India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for incident lifecycle tooling and operational reliability systems.",
    student_perception:
      "Production reliability product setup with practical backend and data-platform ownership opportunities.",
  },
  {
    company_name: "Merge.dev India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for unified API integrations and data sync infrastructure systems.",
    student_perception:
      "Integration-platform environment with balanced backend and platform reliability exposure.",
  },
  {
    company_name: "WorkOS India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for enterprise SSO, user management, and auth infrastructure systems.",
    student_perception:
      "Identity infrastructure product environment with strong backend and reliability engineering opportunities.",
  },
  {
    company_name: "Stytch India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for passwordless auth, fraud detection, and identity workflow systems.",
    student_perception:
      "Identity API platform setup with practical backend and distributed systems ownership.",
  },
  {
    company_name: "Clerk India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for embeddable auth and user management systems for developers.",
    student_perception:
      "Developer-first auth platform with practical backend and platform design opportunities.",
  },
  {
    company_name: "Sublime Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for phishing detection and email security automation systems.",
    student_perception:
      "Security product setup with practical backend and reliability exposure.",
  },
  {
    company_name: "Tailscale India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and systems fundamentals for secure networking, connectivity, and access control infrastructure.",
    student_perception:
      "Network infrastructure environment with practical backend and systems reliability ownership.",
  },
  {
    company_name: "Polar Signals India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and observability-platform fundamentals for continuous profiling and performance optimization systems.",
    student_perception:
      "Performance tooling setup with balanced backend and product systems ownership.",
  },
];
...
writeFileSync(
  "data/companies/companies_batch_35.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_35.json with",
  batch.length,
  "companies",
);
