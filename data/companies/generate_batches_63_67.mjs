...
const batches = {
  63: {
    name: "Building Materials, Paint, and Cements",
    companies: [
      "Berger Paints India",
  ...
  65: {
    name: "Fast Food, Restaurants, and Cloud Kitchens",
    companies: [
  ...
  66: {
    name: "Defense, Aerospace, and Strategic Mfg",
    companies: [
  ...
  67: {
    name: "Ports, Shipping, and Maritime Infra",
    companies: [
