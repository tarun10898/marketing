...
const companies = [
  {
    ...
    eligibility:
      "Strong coding and platform fundamentals for event-driven automation and integration workflow systems.",
    student_perception:
      "Automation-first platform environment with practical backend and reliability ownership opportunities.",
  },
  {
    company_name: "Svix India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for secure, reliable webhook delivery and developer event systems.",
    student_perception:
      "Developer infrastructure environment with practical backend and performance engineering scope.",
  },
  {
    company_name: "Hookdeck India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for event ingestion, retry logic, and webhook reliability systems.",
    student_perception:
      "Infrastructure-product environment with practical backend and data-platform ownership opportunities.",
  },
  {
    company_name: "n8n India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for workflow orchestration and app automation systems.",
    student_perception:
      "Automation platform environment with balanced backend and platform reliability exposure.",
  },
  {
    company_name: "Kestra India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and distributed systems fundamentals for workflow scheduling, orchestration, and pipeline reliability.",
    student_perception:
      "Workflow infrastructure product environment with strong backend and reliability engineering opportunities.",
  },
  {
    company_name: "Windmill India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for developer automation, scripting, and internal tools workflows.",
    student_perception:
      "Developer tooling setup with practical backend and distributed systems ownership.",
  },
  {
    company_name: "Browserbase India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and systems fundamentals for managed browser execution and automation reliability platforms.",
    student_perception:
      "Browser infrastructure environment with practical backend and platform design opportunities.",
  },
  {
    company_name: "LangGraph India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for stateful AI agent orchestration and execution systems.",
    student_perception:
      "Agent orchestration platform setup with practical backend and reliability exposure.",
  },
  {
    company_name: "LlamaIndex India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and data-platform fundamentals for retrieval-augmented generation and knowledge system platforms.",
    student_perception:
      "AI data platform environment with practical backend and systems reliability ownership.",
  },
  {
    company_name: "Sanity India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for structured content, APIs, and collaborative editorial systems.",
    student_perception:
      "Content platform setup with balanced backend and product systems ownership.",
  },
];
...
writeFileSync(
  "data/companies/companies_batch_34.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_34.json with",
  batch.length,
  "companies",
);
