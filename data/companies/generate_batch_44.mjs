...
const companyNames = [
  ...
  "Exabeam India",
  "LogRhythm India",
  "Devo Technology India",
  "Trellix India",
  "Skyhigh Security India",
  "Menlo Security India",
  "Bugcrowd India",
  "HackerOne India",
  "Cobalt Security India",
  "Detectify India",
  "Intruder Systems India",
  "Arkose Labs India",
  "HUMAN Security India",
  "Radware India",
  "Blackpoint Cyber India",
  "Huntress Labs India",
  "Recorded Future India",
  "Flashpoint Intelligence India",
  "EclecticIQ India",
  "BlueVoyant India",
  "Bishop Fox India",
  "NetSPI India",
...
const companies = companyNames.map((companyName) => ({
  ...
  eligibility:
    "Strong coding and platform fundamentals for secure backend systems, observability, and cloud-native reliability workflows.",
  student_perception:
    "Security-focused product setup with practical backend ownership and distributed systems exposure.",
}));
...
writeFileSync(
  "data/companies/companies_batch_44.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_44.json with",
  batch.length,
  "companies",
);
