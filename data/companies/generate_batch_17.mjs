...
const companies = [
  {
    ...
    category: 'product',
    multiplier: 1.1,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Performance Engineering', 'Cloud', 'TypeScript'],
    eligibility: 'Strong coding and product-engineering fundamentals for fast and reliable collaborative SaaS systems.',
    student_perception: 'High-ownership product engineering environment with strong backend and platform depth.',
  },
  {
    company_name: 'Notion India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Cloud', 'TypeScript', 'Distributed Systems'],
    eligibility: 'Strong coding and product-platform fundamentals for collaboration and knowledge management systems.',
    student_perception: 'Product-centric engineering culture with strong full-stack and platform ownership opportunities.',
  },
  {
    company_name: 'Asana India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.1,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Distributed Systems', 'Cloud', 'Java'],
    eligibility: 'Strong coding and product systems fundamentals for enterprise work management platforms.',
    student_perception: 'Balanced product engineering setup with solid backend and platform design exposure.',
  },
  {
    company_name: 'Monday.com India',
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Cloud', 'TypeScript', 'API Design'],
    eligibility: 'Strong coding and product engineering fundamentals for collaborative workflow platforms.',
    student_perception: 'Fast-paced product environment with practical full-stack and backend growth scope.',
  },
  {
    company_name: 'Airtable India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Data Modeling', 'Cloud', 'TypeScript'],
    eligibility: 'Strong coding and data-platform fundamentals for collaborative database and app-platform systems.',
    student_perception: 'Strong product engineering culture with meaningful backend and platform design opportunities.',
  },
  {
    company_name: 'Figma India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'Frontend Performance', 'Backend Engineering', 'Cloud', 'TypeScript'],
    eligibility: 'Strong product engineering fundamentals across frontend and backend for collaborative design tools.',
    student_perception: 'High-impact product company with strong engineering quality and collaborative tooling exposure.',
  },
  {
    company_name: 'Canva India',
    ...
    category: 'product',
    multiplier: 1.1,
    preferred_skills: ['DSA', 'System Design', 'Frontend Engineering', 'Backend Engineering', 'Cloud', 'Java/TypeScript'],
    eligibility: 'Strong product and platform engineering fundamentals for high-scale creative collaboration systems.',
    student_perception: 'Well-regarded product engineering culture with broad scope across frontend and platform work.',
  },
  {
    company_name: 'Zapier India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Workflow Systems', 'Cloud', 'Python'],
    eligibility: 'Strong coding and platform fundamentals for workflow automation and integration infrastructure.',
    student_perception: 'Practical SaaS engineering setup with good backend ownership and integration-heavy systems work.',
  },
  {
    company_name: 'Smartsheet India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    ...
    multiplier: 1.06,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Distributed Systems', 'Cloud', 'Java'],
    eligibility: 'Strong coding and product-platform fundamentals for enterprise work execution systems.',
    student_perception: 'Enterprise SaaS engineering environment with solid backend and platform reliability focus.',
  },
  {
    company_name: 'Amplitude India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.09,
    preferred_skills: ['DSA', 'System Design', 'Data Engineering', 'Distributed Systems', 'Cloud', 'Python/Java'],
    eligibility: 'Strong coding and data-platform fundamentals for product analytics and event-processing systems.',
    student_perception: 'Data-focused product engineering environment with meaningful distributed systems exposure.',
  },
];
...
writeFileSync('data/companies/companies_batch_17.json', `${JSON.stringify(batch, null, 2)}\n`, 'utf8');
console.log('Created data/companies/companies_batch_17.json with', batch.length, 'companies');
