...
const companies = [
  {
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'API Platforms', 'Cloud', 'Python/TypeScript'],
    eligibility: 'Strong coding and API-platform fundamentals for communication and workflow automation products.',
    student_perception: 'Developer-focused product setup with practical backend and platform ownership opportunities.',
  },
  {
    company_name: 'Workato India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.09,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Integration Platforms', 'Cloud', 'Java/TypeScript'],
    eligibility: 'Strong coding and platform fundamentals for enterprise integration and workflow orchestration systems.',
    student_perception: 'Strong B2B platform engineering culture with balanced backend and product depth.',
  },
  {
    company_name: 'Tray.io India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'API Integrations', 'Cloud', 'TypeScript'],
    eligibility: 'Strong coding and integration-platform fundamentals for automation and connector-heavy products.',
    student_perception: 'Practical product engineering setup with good backend ownership and systems design exposure.',
  },
  {
    company_name: 'Aircall India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.07,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Realtime Systems', 'Cloud', 'Java/TypeScript'],
    eligibility: 'Strong coding and communication-platform fundamentals for real-time customer engagement systems.',
    student_perception: 'SaaS engineering environment with practical backend and reliability learning opportunities.',
  },
  {
    company_name: 'Apollo.io India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    ...
    eligibility: 'Strong coding and data-platform fundamentals for revenue intelligence and enrichment products.',
    student_perception: 'Data-centric product company with meaningful backend and pipeline engineering scope.',
  },
  {
    company_name: 'Monte Carlo India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.1,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Data Quality', 'Cloud', 'Python'],
    eligibility: 'Strong coding and data-observability fundamentals for pipeline reliability and monitoring products.',
    student_perception: 'Strong data engineering environment with practical backend and analytics systems depth.',
  },
  {
    company_name: 'Datafold India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Data Diffing', 'Cloud', 'Python/TypeScript'],
    eligibility: 'Strong coding and data-platform fundamentals for data testing and transformation reliability systems.',
    student_perception: 'Practical data-tooling company with good backend and platform ownership opportunities.',
  },
  {
    company_name: 'Tines India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Security Automation', 'Cloud', 'TypeScript'],
    eligibility: 'Strong coding and automation-platform fundamentals for security and workflow orchestration products.',
    student_perception: 'Automation-focused product environment with practical backend and systems design work.',
  },
  {
    company_name: 'Dagster India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    ...
    eligibility: 'Strong coding and data-orchestration fundamentals for reliable data and ML workflow platforms.',
    student_perception: 'Data platform engineering culture with strong backend and reliability-focused system exposure.',
  },
  {
    company_name: 'Meroxa India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Realtime Data', 'Cloud', 'Go/Python'],
    eligibility: 'Strong coding and streaming-data fundamentals for event-driven integration and pipeline platforms.',
    student_perception: 'Data-integration focused engineering setup with practical backend and distributed systems scope.',
  },
];
...
writeFileSync('data/companies/companies_batch_21.json', `${JSON.stringify(batch, null, 2)}\n`, 'utf8');
console.log('Created data/companies/companies_batch_21.json with', batch.length, 'companies');
