...
const companies = [
  {
    company_name: "Cado Security India",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for cloud forensics and incident investigation tooling systems.",
    student_perception:
      "Forensics-focused security platform with practical backend and reliability ownership opportunities.",
  },
  {
    company_name: "LimaCharlie India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for detection engineering and security automation infrastructure.",
    student_perception:
      "Security operations platform with practical backend and performance engineering scope.",
  },
  {
    company_name: "P0 Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for cloud identity and security posture automation systems.",
    student_perception:
      "Cloud security platform setup with practical backend and data-platform ownership opportunities.",
  },
  {
    company_name: "Nudge Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for SaaS governance and identity risk management systems.",
    student_perception:
      "SaaS security infrastructure environment with balanced backend and platform reliability exposure.",
  },
  {
    company_name: "Vorlon Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for API security visibility and runtime threat protection systems.",
    student_perception:
      "API security platform with strong backend and reliability engineering opportunities.",
  },
  {
    company_name: "Tuskira India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for AI-assisted security operations and incident triage systems.",
    student_perception:
      "Security AI product platform with practical backend and distributed systems ownership.",
  },
  {
    company_name: "Torq India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and systems fundamentals for security orchestration and automated response workflow platforms.",
    student_perception:
      "Security orchestration platform with practical backend and platform design opportunities.",
  },
  {
    company_name: "Radiant Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for SOC automation and AI-driven security alert handling systems.",
    student_perception:
      "Security operations product setup with practical backend and reliability exposure.",
  },
  {
    company_name: "Blackbird.AI India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and data-platform fundamentals for disinformation analysis and digital risk intelligence systems.",
    student_perception:
      "Digital risk intelligence platform with practical backend and systems reliability ownership.",
  },
  {
    company_name: "ProjectDiscovery India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for reconnaissance tooling and attack surface discovery systems.",
    student_perception:
      "Security tooling platform with balanced backend and product systems ownership.",
  },
];
...
writeFileSync(
  "data/companies/companies_batch_37.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_37.json with",
  batch.length,
  "companies",
);
