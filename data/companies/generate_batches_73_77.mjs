...
const batches = {
  73: {
    name: "Wood, Timber, and Laminates",
    companies: [
  ...
  74: {
    name: "Glass, Glassware, and Fiberglass",
    companies: [
  ...
  75: {
    name: "Tea, Coffee, and Spice Processing",
    companies: [
      "Tata Spices India",
  ...
  76: {
    name: "Renewable Energy Developers and Equipment",
    companies: [
  ...
  77: {
    name: "Luxury Boutique Retail and Lifestyle Brands",
    companies: [
