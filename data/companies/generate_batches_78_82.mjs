...
const batches = {
  78: {
    name: "Paints, Chemicals, and Fertilizers",
    companies: [
  ...
  79: {
    name: "Construction Engineering and EPC Projects",
    companies: [
  ...
  80: {
    name: "Electric Cables, Wires, and Power Gears",
    companies: [
  ...
  81: {
    name: "Writing Instruments, Household, and Personal Care",
    companies: [
  ...
  82: {
    name: "Watches, Eyewear, and Luxury Accessories",
    companies: [
      "Fastrack India",
      "Timex Group India",
      "HMT Watches India",
