...
const batches = {
  58: {
    name: "Textile, Apparel, and Fashion",
    companies: [
  ...
  59: {
    name: "Paper, Packaging, and Printing",
    companies: [
  ...
  60: {
    name: "Specialty Chemicals, Gems, and Jewelry",
    companies: [
      "PC Jeweller India",
      "Senco Gold India",
  ...
  61: {
    name: "Power Distribution and Renewable Energy",
    companies: [
  ...
  62: {
    name: "Footwear, Leather Products, and Accessories",
    companies: [
      "Bata India",
