...
const companies = [
  {
    company_name: "Aikido Security India",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for application security automation and vulnerability management systems.",
    student_perception:
      "Security-first platform environment with practical backend and reliability ownership opportunities.",
  },
  {
    company_name: "Pangea India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for secure developer APIs and managed security service infrastructure.",
    student_perception:
      "Security API platform with practical backend and performance engineering scope.",
  },
  {
    company_name: "Permit.io India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for policy-based authorization and access control systems.",
    student_perception:
      "Authorization infrastructure setup with practical backend and data-platform ownership opportunities.",
  },
  {
    company_name: "Cerbos India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and systems fundamentals for policy evaluation engines and scalable authorization workflows.",
    student_perception:
      "Policy-infrastructure environment with balanced backend and platform reliability exposure.",
  },
  {
    company_name: "Oso India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for authorization libraries and developer access-control systems.",
    student_perception:
      "Developer-security platform with strong backend and reliability engineering opportunities.",
  },
  {
    company_name: "Opal Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for identity governance, access reviews, and zero-trust security systems.",
    student_perception:
      "Security governance platform with practical backend and distributed systems ownership.",
  },
  {
    company_name: "Hoop.dev India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for secure access brokering and operational workflow systems.",
    student_perception:
      "Security access platform with practical backend and platform design opportunities.",
  },
  {
    company_name: "Stacklok India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for software supply-chain security and policy enforcement systems.",
    student_perception:
      "Supply-chain security product setup with practical backend and reliability exposure.",
  },
  {
    company_name: "Endor Labs India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for dependency analysis and application risk management systems.",
    student_perception:
      "Application security platform with practical backend and systems reliability ownership.",
  },
  {
    company_name: "Socket Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for package risk detection and supply-chain protection systems.",
    student_perception:
      "Security tooling setup with balanced backend and product systems ownership.",
  },
];
...
writeFileSync(
  "data/companies/companies_batch_36.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_36.json with",
  batch.length,
  "companies",
);
