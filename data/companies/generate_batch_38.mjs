...
const companies = [
  {
    company_name: "Harmonic Security India",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for enterprise data security and policy enforcement systems.",
    student_perception:
      "Enterprise security platform with practical backend and reliability ownership opportunities.",
  },
  {
    company_name: "BreachRx India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for breach response workflows and cyber incident lifecycle systems.",
    student_perception:
      "Security response platform with practical backend and performance engineering scope.",
  },
  {
    company_name: "Aembit India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and systems fundamentals for non-human identity and secure workload access management systems.",
    student_perception:
      "Identity security platform setup with practical backend and data-platform ownership opportunities.",
  },
  {
    company_name: "Bionic India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for application security posture and risk remediation systems.",
    student_perception:
      "Application security platform with balanced backend and platform reliability exposure.",
  },
  {
    company_name: "Cyera India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and data-platform fundamentals for cloud data discovery and security posture management systems.",
    student_perception:
      "Data security platform with strong backend and reliability engineering opportunities.",
  },
  {
    company_name: "Dig Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for cloud data monitoring and threat detection systems.",
    student_perception:
      "Cloud security product platform with practical backend and distributed systems ownership.",
  },
  {
    company_name: "DoControl India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for SaaS governance, data exposure control, and remediation systems.",
    student_perception:
      "SaaS governance platform with practical backend and platform design opportunities.",
  },
  {
    company_name: "Seemplicity India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and product-platform fundamentals for vulnerability remediation orchestration and prioritization systems.",
    student_perception:
      "Security remediation product setup with practical backend and reliability exposure.",
  },
  {
    company_name: "Adaptive Shield India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and platform fundamentals for SaaS misconfiguration detection and security posture automation systems.",
    student_perception:
      "SaaS security posture platform with practical backend and systems reliability ownership.",
  },
  {
    company_name: "Grip Security India",
    headquarters: "San Francisco, California, USA",
    india_locations: ["Bengaluru"],
    type: "Product",
    tier: "Tier 2",
    ...
    eligibility:
      "Strong coding and security-platform fundamentals for identity risk detection and SaaS-to-SaaS threat monitoring systems.",
    student_perception:
      "Identity security platform with balanced backend and product systems ownership.",
  },
];
...
writeFileSync(
  "data/companies/companies_batch_38.json",
  `${JSON.stringify(batch, null, 2)}\n`,
  "utf8",
);
console.log(
  "Created data/companies/companies_batch_38.json with",
  batch.length,
  "companies",
);
