...
const batches = {
  113: {
    name: "Cold Chain Storage Chambers and Insulation Panels",
    companies: [
      "Rinac India India",
  ...
  114: {
    name: "Industrial Safety Footwear, Gloves, and Workwear Fabrics",
    companies: [
  ...
  115: {
    name: "Glass Vials, Ampoules, and Laboratory Glassware",
    companies: [
  ...
  116: {
    name: "Performance Polymers, Resins, and Chemical Additives",
    companies: [
      "Kaneka India India",
      "Arkema India India",
      "Solvay India India",
  ...
  117: {
    name: "Sprockets, Couplings, and Mechanical Drive Assemblies",
    companies: [
      "Diamond Chain India",
