...
const companies = [
  ...
  },
  {
    ...
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Cloud', 'API Design', 'Java/TypeScript'],
    eligibility: 'Strong coding and product-platform fundamentals for scheduling and workflow automation systems.',
    student_perception: 'Solid product engineering culture with practical backend and platform ownership opportunities.',
  },
  {
    company_name: 'Loom India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Media Systems', 'Cloud', 'TypeScript'],
    eligibility: 'Strong coding and product engineering fundamentals for async communication and media delivery platforms.',
    student_perception: 'Product-focused engineering setup with practical backend and performance-oriented work.',
  },
  {
    company_name: 'Coda India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    ...
    eligibility: 'Strong coding and product-platform fundamentals for collaborative document and data workflows.',
    student_perception: 'Practical product engineering environment with useful backend and platform ownership scope.',
  },
  {
    company_name: 'Rippling India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.11,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Distributed Systems', 'Cloud', 'Java/Go'],
    eligibility: 'Strong coding and product systems fundamentals for workforce and fintech platform infrastructure.',
    student_perception: 'High-ownership engineering setup with broad backend and platform reliability exposure.',
  },
  {
    company_name: 'Gong India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.09,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Data Pipelines', 'Cloud', 'Python/Java'],
    eligibility: 'Strong coding and data-platform fundamentals for conversational intelligence and analytics products.',
    student_perception: 'Data-rich product engineering environment with meaningful backend and ML-adjacent exposure.',
  },
  {
    company_name: 'Mixpanel India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Data Engineering', 'Distributed Systems', 'Cloud', 'Python'],
    eligibility: 'Strong coding and data infrastructure fundamentals for product analytics platforms.',
    student_perception: 'Analytics-focused engineering setup with strong backend and event-pipeline depth.',
  },
  {
    company_name: 'Webflow India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    category: 'product',
    multiplier: 1.08,
    preferred_skills: ['DSA', 'System Design', 'Frontend Engineering', 'Backend Engineering', 'Cloud', 'TypeScript'],
    eligibility: 'Strong product engineering fundamentals for web experience and developer platform systems.',
    student_perception: 'Modern product engineering culture with balanced frontend and backend growth opportunities.',
  },
  {
    company_name: 'Plaid India',
    headquarters: 'San Francisco, California, USA',
    india_locations: ['Bengaluru'],
    type: 'Product',
    tier: 'Tier 2',
    ...
    multiplier: 1.12,
    preferred_skills: ['DSA', 'System Design', 'Backend Engineering', 'Distributed Systems', 'Cloud', 'Java/Go'],
    eligibility: 'Strong coding and reliability fundamentals for fintech APIs and financial data infrastructure.',
    student_perception: 'High-quality fintech product engineering environment with deep backend systems exposure.',
  },
];
...
writeFileSync('data/companies/companies_batch_18.json', `${JSON.stringify(batch, null, 2)}\n`, 'utf8');
console.log('Created data/companies/companies_batch_18.json with', batch.length, 'companies');
